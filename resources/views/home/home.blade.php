<section id="home" class="section p-[24px] h-full lg:max-h-screen scroll-mt-16">
    <div class="lg:grid lg:grid-cols-2 gap-8">
        <div class="mb-12 items-center">
            ...
            <span class="text-gray-900 text-md">Whether it's a pep rally or a parent-teacher conference, plan, manage, and execute events in minutes — all in one place!</span>
            <br>
